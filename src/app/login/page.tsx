...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-[#1a1a1a] relative">
            {/* Background glow */}
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[800px] bg-[#FFBB00]/10 blur-[120px] rounded-full -z-10 pointer-events-none" />

            <main className="w-full max-w-[1100px] h-[850px] md:h-[750px] bg-gray-50 dark:bg-[#121212] rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row relative">
                {/* Left Panel — Form */}
                <div className="w-full md:w-1/2 p-6 md:p-10 lg:p-12 flex flex-col relative bg-white dark:bg-zinc-900 overflow-y-auto scrollbar-hide">
                    ...
                    <div className="bg-gray-100 dark:bg-zinc-800 rounded-full p-1 flex mb-6 shrink-0">
                        <button
                            ...
                            className={`flex-1 py-2 text-sm font-medium transition-all rounded-full ${mode === "login"
                        ...
                        <button
                            ...
                            className={`flex-1 py-2 text-sm font-medium transition-all rounded-full ${mode === "register"
                                    ? "bg-white dark:bg-zinc-700 shadow-sm font-semibold text-gray-900 dark:text-white"
                                    : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300"
                                }`}
                        >
                    ...
                    <form className="space-y-4">
                        ...
                        <div className={mode === "register" ? "flex gap-4" : ""}>
                            <div className={`relative group ${mode === "register" ? "w-1/2" : "w-full"}`}>
                                <input
                                    className="w-full pl-4 pr-10 py-3 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-xl text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-[#FFBB00]/50 focus:border-[#FFBB00] transition-all text-sm placeholder-gray-400"
                                    placeholder="Senha"
                                    type="password"
                        ...
                        {mode === "register" && (
                            <div className="flex items-center text-sm py-1">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input
                                        className="w-4 h-4 rounded text-[#FFBB00] border-gray-300 focus:ring-[#FFBB00]"
                                        type="checkbox"
                                    />
                                    <span className="text-gray-600 dark:text-gray-400 text-xs">
                                        Concordo com os{" "}
                                        <a className="text-[#FFBB00] hover:underline" href="#">
                                            Termos
                                        </a>{" "}
                                        e{" "}
                                        <a className="text-[#FFBB00] hover:underline" href="#">
                ...
                <div className="hidden md:block w-1/2 relative bg-[#353535] overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#1a1a1a]/90 via-[#353535]/50 to-blue-900/40" />
                    <div className="absolute inset-0 bg-gradient-to-tr from-black via-transparent to-transparent opacity-90" />

                    {/* Decorative elements */}
                    <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-[#FFBB00]/20 rounded-full blur-3xl animate-pulse" />
                    <div className="absolute bottom-1/3 right-1/4 w-24 h-24 bg-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
                    <div className="absolute top-1/2 right-1/3 w-16 h-16 bg-[#FFBB00]/15 rounded-full blur-2xl animate-pulse" style={{ animationDelay: "2s" }} />
