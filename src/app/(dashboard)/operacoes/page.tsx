...
const recentActivity = [
    {
        ...
        volume: "$45,200.00",
        health: "Optimal",
        healthColor: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 border-emerald-200",
    },
    {
        id: "#OP-9480",
        network: "TikTok Ads",
        ...
        volume: "$12,840.44",
        health: "Review",
        healthColor: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400 border-amber-200",
    },
];
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex gap-2">
                        <button type="button" className="px-5 py-2 bg-foreground text-background rounded-full text-xs font-semibold shadow-md">
                            Todas (86)
                        </button>
                        <button type="button" className="px-5 py-2 hover:bg-muted text-muted-foreground hover:text-foreground rounded-full text-xs font-semibold transition-colors">
                            Ativas
                        </button>
                        <button type="button" className="px-5 py-2 hover:bg-muted text-muted-foreground hover:text-foreground rounded-full text-xs font-semibold transition-colors">
                            Pausadas
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button type="button" className="flex items-center gap-2 text-xs font-bold bg-card border px-4 py-2 rounded-lg hover:bg-muted transition-colors shadow-sm">
                            Margem de Lucro
                    ...
                    {operations.map((op) => (
                        ...
                        >
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <div className="flex gap-2">
                                    <button type="button" className="p-2 hover:bg-card rounded-lg text-muted-foreground hover:text-foreground transition-all">
                                        <Edit className="h-4 w-4" />
                                    </button>
                                    <button type="button" className="p-2 hover:bg-red-50 dark:hover:bg-red-950 rounded-lg text-muted-foreground hover:text-red-600 transition-all">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                                ...
                                <div className="bg-card p-4 rounded-2xl border shadow-sm">
                                    ...
                                    <span className={`text-lg font-bold ${op.profitPositive ? "" : "text-orange-500"}`}>
                                        {op.profit}
                                    </span>
                                </div>
                            </div>
                            <div className="flex items-center justify-between mt-4">
                                ...
                                <div className="flex gap-2">
                                    {op.tags.map((tag) => (
                                        <Badge key={tag} variant="outline" className="text-[10px] font-bold rounded-full">
                                            {tag}
                                        </Badge>
                                    ))}
                                </div>
                ...
                <div className="flex justify-center items-center gap-2 py-4">
                    <button type="button" className="flex items-center gap-2 px-4 py-2 bg-muted text-foreground rounded-xl text-xs font-bold transition-all">
                        <ChevronLeft className="h-3 w-3" /> Anterior
                    </button>
                    <div className="flex items-center gap-2 mx-4">
                        <button type="button" className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#FFBB00] text-black font-bold text-sm shadow-md">1</button>
                        <button type="button" className="w-10 h-10 flex items-center justify-center rounded-xl bg-card border hover:bg-muted font-bold text-sm transition-all">2</button>
                        <button type="button" className="w-10 h-10 flex items-center justify-center rounded-xl bg-card border hover:bg-muted font-bold text-sm transition-all">3</button>
                        <span className="text-muted-foreground px-1">...</span>
                        <button type="button" className="w-10 h-10 flex items-center justify-center rounded-xl bg-card border hover:bg-muted font-bold text-sm transition-all">14</button>
                    </div>
                    <button type="button" className="flex items-center gap-2 px-4 py-2 bg-muted text-foreground rounded-xl text-xs font-bold transition-all">
                ...
                <div className="bg-card rounded-3xl border shadow-sm overflow-hidden">
                    <div className="p-6 border-b flex items-center justify-between bg-muted/50">
                        ...
                        <button type="button" className="text-xs font-bold text-[#FFBB00] uppercase tracking-widest hover:underline">
                            Ver Todos
                        </button>
                    </div>
                    <Table>
                        ...
                        <TableBody>
                            {recentActivity.map((a) => (
                                <TableRow key={a.id} className="hover:bg-muted/50 transition-colors">
                                    <TableCell className="px-8 py-5 text-sm font-medium">{a.id}</TableCell>
                                    ...
                                    <TableCell className="px-8 py-5 text-sm text-muted-foreground">{a.lastSync}</TableCell>
                                    <TableCell className="px-8 py-5 text-sm font-bold text-right">{a.volume}</TableCell>
                                    <TableCell className="px-8 py-5">
                                        <div className="flex justify-center">
                                            <Badge variant="outline" className={`text-[10px] font-black uppercase border ${a.healthColor}`}>
                                                {a.health}
                                            </Badge>
                                        </div>
                                    </TableCell>
