        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card>
            <CardContent className="p-6 flex flex-col">
              ...
              <div className="flex-1 flex items-center justify-center relative min-h-60">
                <div
            ...
            <CardContent className="p-6 flex flex-col">
              ...
              <div className="flex-1 flex items-end gap-2 h-64 w-full px-2 pb-2 relative border-b border-l border-border/50">
                {barChart.map((b) => (
                  ...
                  >
                    <div
                      className={`w-full max-w-10 rounded-t-sm relative ${
                        b.highlight
                ...
                >
                  <TableCell className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-8 h-8 rounded bg-linear-to-br ${t.gradientFrom} ${t.gradientTo} flex items-center justify-center text-white text-xs font-bold`}
                      >
                        {t.initials}
                      </div>
                      <div>
