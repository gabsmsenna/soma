      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <button
              type="button"
              className="flex items-center gap-2 px-4 py-2 bg-muted rounded-lg text-sm font-medium text-muted-foreground hover:text-foreground transition-colors"
            >
          ...
          {creatives.map((c) => (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div
                  className={`h-10 w-10 ${c.iconBg} rounded-lg flex items-center justify-center`}
                >
