                        ...
                        <Card key={kpi.label} className="backdrop-blur-sm">
                            <CardContent className="p-6">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <span
                                        className={`text-xs font-bold flex items-center gap-1 ${kpi.changePositive ? "text-green-500" : "text-muted-foreground"
                                            }`}
                                    >
                                        {kpi.change}
                                        {kpi.changePositive && (
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="h-72 w-full relative">
                                <svg
                                    ...
                                    viewBox="0 0 800 240"
                                >
                                    <line stroke="currentColor" className="text-muted/30" strokeWidth="1" x1="0" x2="800" y1="40" y2="40" />
                                    <line stroke="currentColor" className="text-muted/30" strokeWidth="1" x1="0" x2="800" y1="80" y2="80" />
                                    <line stroke="currentColor" className="text-muted/30" strokeWidth="1" x1="0" x2="800" y1="120" y2="120" />
                                    <line stroke="currentColor" className="text-muted/30" strokeWidth="1" x1="0" x2="800" y1="160" y2="160" />
                                    <line stroke="currentColor" className="text-muted/30" strokeWidth="1" x1="0" x2="800" y1="200" y2="200" />
                                    <defs>
                                        <linearGradient id="comGrad" x1="0%" x2="0%" y1="0%" y2="100%">
                                            <stop offset="0%" style={{ stopColor: "#FFBB00", stopOpacity: 0.2 }} />
                                            <stop offset="100%" style={{ stopColor: "#FFBB00", stopOpacity: 0 }} />
                                        </linearGradient>
                                    </defs>
                                    <path d="M0 200 Q 100 190, 200 150 T 400 130 T 600 80 T 800 50 L 800 240 L 0 240 Z" fill="url(#comGrad)" />
                                    <path d="M0 200 Q 100 190, 200 150 T 400 130 T 600 80 T 800 50" fill="none" stroke="#FFBB00" strokeWidth="3" />
                                </svg>
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="relative flex justify-center items-center h-48 mb-6">
                                <svg className="w-40 h-40 transform -rotate-90" viewBox="0 0 36 36">
                                    <circle className="text-muted" cx="18" cy="18" fill="none" r="15.915" stroke="currentColor" strokeDasharray="100, 100" strokeWidth="4" />
                                    <circle className="text-[#FFBB00]" cx="18" cy="18" fill="none" r="15.915" stroke="currentColor" strokeDasharray="50, 100" strokeLinecap="round" strokeWidth="4" />
                                    <circle className="text-orange-500" cx="18" cy="18" fill="none" r="15.915" stroke="currentColor" strokeDasharray="25, 100" strokeDashoffset="-50" strokeLinecap="round" strokeWidth="4" />
                                    <circle className="text-amber-300" cx="18" cy="18" fill="none" r="15.915" stroke="currentColor" strokeDasharray="15, 100" strokeDashoffset="-75" strokeLinecap="round" strokeWidth="4" />
                                </svg>
